...
Page({
  ...
  onLoad(options) {
    ...
    togetPhonenum: function(event) {
      ...
      db.collection('login_admin').where({
        adminPhone: phone
      }).get({
        success(res){
    ...
    tologin: function() {
      ...
      if(this.data.phonelen) {
        ...
        // 再验证密码是否正确
        if(this.data.pwd == app.globalData.userDetail.adminPwd)
        {
          // 登陆成功
          wx.showToast({
            title: '登录成功',
                  ...
                  if(res.data.length == 0) {
                    ...
                    db.collection('login_users').add({
                      data: {
                        ...
                        realName: userDetail.adminName,
                        userphone: userDetail.adminPhone,
                        usersection: userDetail.adminSection,
                        userhouse: userDetail.adminHouse,
